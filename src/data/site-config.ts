...
const siteConfig: SiteConfig = {
    ...
    description:
        'Dustin Turner is a Software Design Engineer based in Knoxville, TN. He is currently seeking opportunities in the financial services or healthcare space.',
    image: {
        src: '/dante-preview.jpg',
        alt: 'Dustin Turner | Software Design Engineer'
    },
    headerNavLinks: [
        {
            text: 'Home',
